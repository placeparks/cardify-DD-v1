  ...
  <div className="min-h-screen bg-cyber-black relative overflow-hidden font-mono">
    ...
    <div className="px-6 py-8 pt-24 relative max-w-7xl mx-auto">
          ...
          <div className="space-y-2">
            ...
            {!isEditingName ? (
              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                <button
                  className={`min-h-[44px] sm:min-h-[40px] py-2 rounded border border-cyber-cyan/30 bg-cyber-dark/60 text-white flex items-center transition-colors touch-manipulation ${
                    !displayName && !nameLoading
                      ? "px-4 gap-2 justify-center hover:border-cyber-cyan/50 hover:bg-cyber-dark/80 cursor-pointer w-full sm:w-auto"
                      : "min-w-[12rem] px-3 cursor-default w-full sm:w-auto"
                  }`}
                  onClick={() => {
                ...
                {displayName && !nameLoading && (
                  <Button
                    variant="ghost"
                    size="icon"
                    className="border border-cyber-cyan/30 hover:bg-white/5 h-10 w-10 sm:h-9 sm:w-9 touch-manipulation"
                    onClick={() => {
              ...
              <div className="space-y-3">
                <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                  <Input
                    ...
                    className={`w-full sm:w-72 bg-cyber-dark/60 border ${
                      nameError 
                  ...
                  <div className="flex gap-2 sm:ml-3">
                    <Button
                      ...
                      size="sm"
                      className="border-2 border-cyber-cyan bg-cyber-dark/60 text-cyber-cyan hover:bg-cyber-cyan/10 h-10 sm:h-9 px-4 touch-manipulation flex-1 sm:flex-none"
                      title="Save name"
                    >
                      {nameSaving ? (
                        <>
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className="border-2 border-red-500/30 text-red-400 hover:bg-red-500/10 hover:text-red-400 h-10 sm:h-9 px-4 touch-manipulation flex-1 sm:flex-none"
                      onClick={() => {
                        setIsEditingName(false)
                        setDraftName("")
                        setNameError(null)
      ...
      <Tabs defaultValue="cards" className="w-full">
        ...
        <TabsContent value="cards" className="space-y-8 sm:space-y-14">
  ...
  {loadingAssets ? (
    ...
    <>
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 sm:gap-4">
        ...
        <TabsContent value="purchases" className="space-y-8 sm:space-y-14">
          {/* Purchases */}
          <section className="mb-8 sm:mb-14">
        <div className="flex items-end justify-between mb-3 sm:mb-4">
        ...
        <TabsContent value="transactions" className="space-y-8 sm:space-y-14">
          {/* Transaction History */}
          <section className="mb-8 sm:mb-14">
            <div className="flex items-end justify-between mb-3 sm:mb-4">
