...
export const FlippableCardPreview = memo(function FlippableCardPreview({ artwork, isLoading = false, defaultImage = "/generate_default_image.webp", useSimpleLoader = false }: FlippableCardPreviewProps) {
            ...
            <div className="relative w-full h-full rounded-2xl border-2 border-cyber-cyan/50 shadow-2xl cyber-card-glow-gradient overflow-hidden">
              ...
              {isLoading ? (
                (isLowPerf || useSimpleLoader) ? (
                  // Cyberpunk-themed ultra-lightweight mobile animation
                  <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-cyber-dark to-cyber-darker rounded-xl">
                    <div className="flex flex-col items-center">
                      {/* Cyberpunk circuit board loader */}
                      <div className="relative w-24 h-24 flex items-center justify-center mb-4">
                        ...
                        {/* Percentage in center - hidden for simple loader */}
                        {!useSimpleLoader && (
                          <div className="absolute inset-0 flex items-center justify-center">
                            <div className="text-cyber-cyan font-mono font-bold text-lg cyber-percentage">
                              {mobileProgress}
                      ...
                      <div className="text-center">
                        <div className="text-cyber-cyan text-xs font-bold tracking-wider mb-2 uppercase">
                        ...
                        {/* Minimal progress indicator - hidden for simple loader */}
                        {!useSimpleLoader && (
                          <div className="flex justify-center gap-1">
                            <div className={`w-8 h-1 ${mobileProgress > 0 ? 'bg-cyber-cyan' : 'bg-cyber-dark'} transition-colors duration-300`} />
                            <div className={`w-8 h-1 ${mobileProgress > 33 ? 'bg-cyber-cyan' : 'bg-cyber-dark'} transition-colors duration-300`} />
                            <div className={`w-8 h-1 ${mobileProgress > 66 ? 'bg-cyber-cyan' : 'bg-cyber-dark'} transition-colors duration-300`} />
                          </div>
                        )}
                      </div>
